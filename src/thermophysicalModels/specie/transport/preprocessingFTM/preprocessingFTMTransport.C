...
template<class Thermo>
Foam::preprocessingFTMTransport<Thermo>::preprocessingFTMTransport(const dictionary& dict)
:
    Thermo(dict),
    // for diffusivity
...
template<class Thermo>
inline Foam::autoPtr<Foam::preprocessingFTMTransport<Thermo>>
Foam::preprocessingFTMTransport<Thermo>::New
(
...
)
{
    return autoPtr<preprocessingFTMTransport<Thermo>>
    (
        new preprocessingFTMTransport<Thermo>(dict)
    );
}
